...
valid'''               :: Op -> Result -> Result -> Bool
valid''' Add (e1,x) (e2,y) = x <= y && non Add e2 && non Sub e1 && non Sub e2
valid''' Sub (e1,x) (e2,y) = x > y && non Sub e1 && non Sub e2
valid''' Mul (e1,x) (e2,y) = x /= 1 && y /= 1 && x <= y && non Mul e2 && non Div e1 && non Div e2
valid''' Div (e1,x) (e2,y) = y /= 1 && x `mod` y == 0 && non Div e1 && non Div e2
...
combine''''            :: Result -> Result -> [Result]
combine'''' (l,x) (r,y) = [(App o l r, apply o x y) | o <- ops, valid''' o (l,x) (r,y)]
